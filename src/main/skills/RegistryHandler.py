...
class sendMalformedError(object):
    ...
    def sendMalformedError_Logic(self):
        ...
        self.InElem[0]["submodelElements"][1]["value"] = "400"
        self.InElem[0]["submodelElements"][2]["value"] = "The syntax of the passed Asset Administration Shell descriptor is not valid or malformed request <Response [400]>"
...
class RegistryHandler(object):
    ...
    def __init__(self, pyAAS):
        ...
        self.SKILL_STATES = {
                          "saveDescriptorDetails": "saveDescriptorDetails",  "Start": "Start",  "sendMalformedError": "sendMalformedError",  "ValidateRegisterMessage": "ValidateRegisterMessage",  "sendRegisterAck": "sendRegisterAck",  "WaitforRegisterMessage": "WaitforRegisterMessage",
                       }
