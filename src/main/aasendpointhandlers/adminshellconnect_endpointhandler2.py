...
class AASEndPointHandler(AASEndPointHandler):
    ...
    def configure(self):
        ...
        self.hb_Message = {"source":"VWS_AAS_Registry","data":[]}
        self.adminShellConnectURI = "http://" + self.ipaddressComdrv + ":" + self.portComdrv + "/publish"
            ...
            try:
                ...
                if (r.text != ""):
                    ...
                    for entry in directoryData["data"]:
                        if (entry["destination"] == "VWS_AAS_Registry"  and entry["type"] == "register" ):
                ...
                pass
            time.sleep(1)
        self.pyAAS.serviceLogger.info("ADMINSHELL Connect Adaptor is started")
