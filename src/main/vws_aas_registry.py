...
try:
    from abstract.saasScheduler import Scheduler
except ImportError:
    from  main.abstract.saasScheduler import Scheduler
...
try:
    from datastore.dbadaptor import DB_ADAPTOR
except ImportError:
    from main.datastore.dbadaptor import DB_ADAPTOR 
...
class vws_aas_registry(object):
    ...
    def configureLogger(self):
        ...
        self.fileLogger_Handler = logging.FileHandler(self.base_dir+"/logs/vws_aas_registry.LOG")
    ...
    def configure(self):
        ...
        #self.scheduler.configure(self.aasConfigurer)
